...
class WellState(models.Model):
    ...
    oil_rate = models.FloatField("Дебит нефти", max_length=30)
    liquid_rate = models.FloatField("Дебит жидкости", max_length=30)
    gas_rate = models.FloatField("Дебит газа", max_length=30)
    bottom_hole_pressure = models.FloatField("Забойное давление", max_length=30)
    formational_pressure = models.FloatField("Пластовое давление", max_length=30)
    pump_parameters_measurement_date = models.DateField("Дата измерения параметров насоса")
    esp_frequency = models.FloatField("Частота ЭЦН", max_length=30)
    esp_pressure = models.FloatField("Напор ЭЦН", max_length=30)
    esp_current = models.FloatField("Ток ЭЦН", max_length=30)
...
class CoreSample(models.Model):
    ...
    gas_connected_porosity = models.FloatField("Открытая пористость по газу", max_length=30)
    water_connected_porosity = models.FloatField("Открытая пористость по воде", max_length=30)
    kerosene_connected_porosity = models.FloatField("Открытая пористость по керосину", max_length=30)
    young_modulus = models.FloatField("Модуль Юнга", max_length=30)
    poissons_ratio = models.FloatField("Коэффициент Пуассона", max_length=30)
...
class Smush(models.Model):
    density_of_drilling_liquid = models.FloatField("Плотность промывочных жидкостей", max_length=30)
    viscosity = models.FloatField("Вязкость", max_length=30)
    filtration_factor = models.FloatField("Показатель фильтрации", max_length=30)
    gel_strength = models.FloatField("Статическое напряжение сдвига", max_length=30)
    stability = models.FloatField("Стабильность", max_length=30)
    daily_feculence = models.FloatField("Суточный отстой", max_length=30)
    gas_concentration = models.FloatField("Содержание газа", max_length=30)
    hydrogen_index = models.FloatField("Водородный показатель", max_length=30)


class Cluster(models.Model):
    name = models.CharField('Название куста', max_length=255)
    x_coordinate = models.FloatField("Координата Х", max_length=30)
    y_coordinate = models.FloatField("Координата Y", max_length=30)
...
class Layer(models.Model):
    ...
    layer_pressure = models.FloatField("Пластовое давление", max_length=30)
    bed_top_occurrence_depth = models.FloatField("Глубина залегания кровли", max_length=30)
    bed_floor_occurrence_depth = models.FloatField("Глубина залегания подошвы", max_length=30)
    net_oil_thickness = models.FloatField("Эффективная нефтенасыщенная толщина", max_length=30)
    porosity = models.FloatField("Пористость", max_length=30)
    full_porosity_ratio = models.FloatField("Коэффициент полной пористости", max_length=30)
    penetrability = models.FloatField("Проницаемость", max_length=30)
